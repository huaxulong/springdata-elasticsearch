...
import com.huaxu.elasticsearch.bean.ChildItem;
...
//        elasticsearchTemplate.putMapping(Item.class);
    ...
    void putMegacorp() {
        ...
        list.add("sports");
        list.add("music");
        ChildItem childItem=new ChildItem(100,"华东旭");
        Item item1=new Item(6L,"华东旭","男",25,list,"技术部开发规范" ,childItem);
        Item item2=new Item(7L,"肖灿","男",32, Arrays.asList("music"),"保险原则",childItem);
        Item item3=new Item(8L,"饶飞","男",35,Arrays.asList("forestry"),"平安护你到家",childItem);
